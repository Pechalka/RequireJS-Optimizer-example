...
define('libs/modul',["knockout", "jquery"
...
define('text!widgets/top_menu/TopMenuViewModel.html',[],function () { return ' <!-- ko foreach : items --> \r\n <a data-bind="text : $data, attr : { href : \'#/\' + $data }, css : { active : $parent.selected_item() == $data}">/a>\r\n <!-- /ko -->';});

define('widgets/top_menu/TopMenuViewModel',["knockout", "jquery",
...
define('stringTemplateEngine',["knockout"],function(ko) {
...
define('text!moduls/base/views/overview.html',[],function () { return 'all students (statistic)';});

define('moduls/base/view_models/overview',["knockout", "jquery",
...
define('text!moduls/base/views/ChangePasswordViewModel.html',[],function () { return '<div id="change_password">\r\n\told password:<input type="text" /><br/>\r\n\tnew password:<input type="text" /><br/>\r\n\t<input type="button" data-bind="click : change" value="change"/> \r\n</div>';});

define('moduls/base/view_models/ChangePasswordViewModel',["knockout", "jquery",
